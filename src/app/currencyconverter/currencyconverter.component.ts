...
export class CurrencyConverterComponent {
  private apiUrl = 'https://v6.exchangerate-api.com/v6/38c2d39cab38b84369aaf73b/latest/';
...
currencies: { code: string, name: string, country: string }[] = [
  ...
  { code: 'STN', name: 'Sao Tome and Principe Dobra', country: 'Sao Tome and Principe' },
  ...
  { code: 'XAG', name: 'Silver Ounce', country: 'International' },
  { code: 'XAU', name: 'Gold Ounce', country: 'International' },
  { code: 'XCD', name: 'East Caribbean Dollar', country: 'Eastern Caribbean' },
  ...
  convertCurrency() {
    ...
    this.http.get<any>(`${this.apiUrl}${this.fromCurrency}`).subscribe(
      (data) => {
